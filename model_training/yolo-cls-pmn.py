...
# 데이터셋 디렉토리
dataset_directory = "C:/Users/wogns/OneDrive/바탕 화면/dl/pneumonia"
# 데이터셋 디렉토리안에 있는 test 폴더 경로 설정
test_folder = "C:/Users/wogns/OneDrive/바탕 화면/dl/pneumonia/test"
...
test_cls = [['NORMAL', 'PNEUMONIA'][i] for i in test_preds]
...
# 분류 보고서 생성
report = classification_report(test_labels, test_cls, target_names=['NORMAL', 'PNEUMONIA'])
print("\nClassification Report:\n", report)
with open(output_directory+'/classification_report_pmn.txt', 'w') as f:
    f.write(report)
...
plt.savefig(output_directory+'/confusion_matrix_pmn.png')
